...
{
    /// <inheritdoc />
    public partial class WindowsCrashReports_Init : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "WindowsCrashReports",
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WindowsCrashReports", x => x.Id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_WindowsCrashReports_AppProcess_CreateDate",
                schema: "xgb_dashopnvpn",
                table: "WindowsCrashReports",
                columns: new[] { "AppProcess", "CreateDate" });

            migrationBuilder.CreateIndex(
                name: "IX_WindowsCrashReports_CreateDate",
                schema: "xgb_dashopnvpn",
                table: "WindowsCrashReports",
                column: "CreateDate");

            migrationBuilder.CreateIndex(
                name: "IX_WindowsCrashReports_ParseStatus",
                schema: "xgb_dashopnvpn",
                table: "WindowsCrashReports",
                column: "ParseStatus");
        }
