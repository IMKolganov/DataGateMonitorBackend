...
public class VpnServerClientConfiguration : BaseEntityConfiguration<VpnServerClient, int>
{
    public override void Configure(EntityTypeBuilder<VpnServerClient> entity)
    {
