...
public static class LocalizationTextSeedData
{
    public static LocalizationText[] GetData() => new[]
    {
        ...
        new LocalizationText
        {
            Id = 109, Key = "DonateIntro", Language = Language.English,
            Text =
        ...
        new LocalizationText
        {
            Id = 110, Key = "DonateIntro", Language = Language.Greek,
            Text =
        ...
        new LocalizationText
        {
            Id = 111, Key = "DonateIntro", Language = Language.Russian,
            Text =
        ...
        new LocalizationText
        {
            Id = 112, Key = "DonatePayButton", Language = Language.English,
            Text = "Pay {amount} USD"
        },
        new LocalizationText
        {
            Id = 113, Key = "DonatePayButton", Language = Language.Greek,
            Text = "Πληρωμή {amount} USD"
        },
        new LocalizationText
        {
            Id = 114, Key = "DonatePayButton", Language = Language.Russian,
            Text = "Оплатить {amount} USD"
        },

        new LocalizationText
        {
            Id = 115, Key = "DonateInvoiceCreated", Language = Language.English,
            Text =
                "Invoice for {amount} USD is ready. Pay from an existing @CryptoBot balance."
        },
        new LocalizationText
        {
            Id = 116, Key = "DonateInvoiceCreated", Language = Language.Greek,
            Text =
                "Το τιμολόγιο για {amount} USD είναι έτοιμο. Πληρωμή από υπάρχον υπόλοιπο @CryptoBot."
        },
        new LocalizationText
        {
            Id = 117, Key = "DonateInvoiceCreated", Language = Language.Russian,
            Text =
        ...
        new LocalizationText
        {
            Id = 118, Key = "DonateThanks", Language = Language.English,
            Text = "Thank you for the {amount} {asset} donation! 💚"
        },
        new LocalizationText
        {
            Id = 119, Key = "DonateThanks", Language = Language.Greek,
            Text = "Ευχαριστούμε για τη δωρεά {amount} {asset}! 💚"
        },
        new LocalizationText
        {
            Id = 120, Key = "DonateThanks", Language = Language.Russian,
            Text = "Спасибо за донат {amount} {asset}! 💚"
        },

        new LocalizationText
        {
            Id = 121, Key = "DonateDisabled", Language = Language.English,
            Text = "Donations are turned off right now."
        },
        new LocalizationText
        {
            Id = 122, Key = "DonateDisabled", Language = Language.Greek,
            Text = "Οι δωρεές είναι απενεργοποιημένες."
        },
        new LocalizationText
        {
            Id = 123, Key = "DonateDisabled", Language = Language.Russian,
            Text = "Донаты сейчас выключены."
        },

        new LocalizationText
        {
            Id = 124, Key = "DonateInvoiceFailed", Language = Language.English,
            Text = "Could not create a payment invoice. Please try again later."
        },
        new LocalizationText
        {
            Id = 125, Key = "DonateInvoiceFailed", Language = Language.Greek,
            Text = "Δεν ήταν δυνατή η δημιουργία τιμολογίου. Δοκιμάστε ξανά αργότερα."
        },
        new LocalizationText
        {
            Id = 126, Key = "DonateInvoiceFailed", Language = Language.Russian,
            Text = "Не удалось создать счёт. Попробуйте позже."
        },

        new LocalizationText
        {
            Id = 127, Key = "DonateStarsTitle", Language = Language.English,
            Text = "Support DataGate"
        },
        new LocalizationText
        {
            Id = 128, Key = "DonateStarsTitle", Language = Language.Greek,
            Text = "Υποστήριξη DataGate"
        },
        new LocalizationText
        {
            Id = 129, Key = "DonateStarsTitle", Language = Language.Russian,
            Text = "Поддержка DataGate"
        },

        new LocalizationText
        {
            Id = 130, Key = "DonateStarsDescription", Language = Language.English,
            Text = "Voluntary support. VPN plan does not change."
        },
        new LocalizationText
        {
            Id = 131, Key = "DonateStarsDescription", Language = Language.Greek,
            Text = "Εθελοντική υποστήριξη. Το πλάνο VPN δεν αλλάζει."
        },
        new LocalizationText
        {
            Id = 132, Key = "DonateStarsDescription", Language = Language.Russian,
            Text = "Добровольная поддержка. Тариф VPN не меняется."
        },

        new LocalizationText
        {
            Id = 133, Key = "DonateCryptoRiskBanner", Language = Language.English,
            Text =
        ...
        new LocalizationText
        {
            Id = 134, Key = "DonateCryptoRiskBanner", Language = Language.Greek,
            Text =
        ...
        new LocalizationText
        {
            Id = 135, Key = "DonateCryptoRiskBanner", Language = Language.Russian,
            Text =
                "<b>⚠️ Внимание: риск!!!</b>\n\n" +
        ...
        new LocalizationText
        {
            Id = 136, Key = "DonateCryptoRiskContinue", Language = Language.English,
            Text = "I understand the risk, continue"
        },
        new LocalizationText
        {
            Id = 137, Key = "DonateCryptoRiskContinue", Language = Language.Greek,
            Text = "Κατανοώ τον κίνδυνο, συνέχεια"
        },
        new LocalizationText
        {
            Id = 138, Key = "DonateCryptoRiskContinue", Language = Language.Russian,
            Text = "Понимаю риск, продолжить"
        },

        new LocalizationText
        {
            Id = 139, Key = "DonateCryptoRiskIgnore", Language = Language.English,
            Text = "Ignore this method"
        },
        new LocalizationText
        {
            Id = 140, Key = "DonateCryptoRiskIgnore", Language = Language.Greek,
            Text = "Αγνόηση αυτής της μεθόδου"
        },
        new LocalizationText
        {
            Id = 141, Key = "DonateCryptoRiskIgnore", Language = Language.Russian,
