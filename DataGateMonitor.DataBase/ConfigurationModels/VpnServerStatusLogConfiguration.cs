...
public class VpnServerStatusLogConfiguration : BaseEntityConfiguration<VpnServerStatusLog, int>
{
    public override void Configure(EntityTypeBuilder<VpnServerStatusLog> entity)
    {
