...
public class VpnServerEventLogConfiguration : BaseEntityConfiguration<VpnServerEventLog, int>
{
    public override void Configure(EntityTypeBuilder<VpnServerEventLog> entity)
    {
        ...
        entity.HasIndex(e => new { e.VpnServerId, e.EventTimeUtc })
              .HasDatabaseName("ix_ovpn_events_server_time");//todo: rename like IX_VpnServerEventLog_VpnServerId_EventTimeUtc
