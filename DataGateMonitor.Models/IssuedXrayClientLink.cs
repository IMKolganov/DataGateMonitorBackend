...
/// <summary>Xray (VLESS) client link record issued via DataGateXRayManager; separate from <see cref="IssuedOvpnFile"/>.</summary>
public class IssuedXrayClientLink : BaseEntity<int>
{
    [Required]
