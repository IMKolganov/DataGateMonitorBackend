...
namespace DataGateMonitor.SharedModels.DataGateOpenVpnManager.OvpnFile.Requests;

public class GenerateOvpnFileRequest
{
    [DefaultValue("")]
    public string FriendlyΝame { get; set; } = string.Empty;
    ...
    [DefaultValue("setenv FRIENDLY_NAME \"{{friendly_name}}\"\nclient\ndev tun\nproto udp\nremote {{server_ip}} {{server_port}}\nresolv-retry infinite\nnobind" +
