...
public class OpenVpnServerClientsControllerTests
{
    private readonly Mock<IOpenVpnServerClientOverviewQuery> _overviewQuery = new();
    ...
    private readonly OpenVpnServerClientsController _controller;

    public OpenVpnServerClientsControllerTests()
    {
        _controller = new OpenVpnServerClientsController(
    ...
    {
        _overviewQuery
            .Setup(q => q.GetAllConnectedOpenVpnServerClientsAsync(5, 2, 25, It.IsAny<CancellationToken>()))
            .ReturnsAsync(new OpenVPNGateMonitor.Models.Helpers.Services.VpnClientInfoResponseList { TotalCount = 0 });
    ...
    {
        _overviewQuery
            .Setup(q => q.GetAllHistoryOpenVpnServerClientsAsync(6, 1, 10, It.IsAny<CancellationToken>()))
            .ReturnsAsync(new OpenVPNGateMonitor.Models.Helpers.Services.VpnClientInfoResponseList { TotalCount = 0 });
