...
public class OvpnFileApiServiceTests
{
        ...
        Mock<IOvpnFileNotificationService>? notification = null)
    {
        ...
        var configQuery = new Mock<IOpenVpnServerOvpnFileConfigQueryService>(MockBehavior.Loose);
        var serverQuery = new Mock<IOpenVpnServerQueryService>(MockBehavior.Loose);
