...
namespace OpenVPNGateMonitor.Tests.Services.Api.Auth.TelegramLogin;
...
public class TelegramLoginCodeServiceTests
{
    ...
    {
        var telegramUserQuery = new Mock<OpenVPNGateMonitor.DataBase.Services.Query.TelegramBotUserTable.ITelegramBotUserQueryService>();
